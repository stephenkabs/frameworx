...
@include('includes.sidebar')
    ...
    <h4 class="card-title">
        ...
        <a class="btn btn-sm btn-info waves-effect waves-light" href="/customs/create"><i class="dripicons-plus"></i></a>
    </h4>
                ...
                <div class="app-buttons">
                    ...
                    <div class="folder-container" style="display: flex; flex-wrap: wrap; gap: 5px;"> <!-- Adjust gap as needed -->
                        ...
                        <div class="folder" style="display: flex; flex-direction: column; align-items: left; text-align: center; margin-bottom: 5px;" oncontextmenu="openDeleteModal(event, '{{ route('customs.destroy', $item->slug) }}')">
