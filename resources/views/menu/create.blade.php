                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-info waves-effect waves-light"
                                            ...
                                            <form class="row needs-validation" action="{{ route('menu.store') }}" novalidate method="POST" enctype="multipart/form-data">
                                                ...
                                                <!-- Menu Name Field -->
                                                <div class="mb-3 position-relative" id="menuNameField">
                                                    <label class="form-label">Menu Name</label>
                                                    <input name="menu_name" type="text" class="form-control" placeholder="Enter Menu Name" />
                                                </div>

                                                <!-- Sub Name and Link Fields -->
                                                <div class="mb-3 position-relative" id="subMenuFields" style="display: none;">
                                                    <label class="form-label">Sub Name</label>
                                                    <input name="sub_name" type="text" class="form-control" placeholder="Enter Sub Name" />
                                                </div>
